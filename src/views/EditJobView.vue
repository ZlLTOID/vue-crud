...
onMounted(async () => {
    try {
        ...
        form.company.name = job.value.company.name
        form.company.description = job.value.company.description
        form.company.contactEmail = job.value.company.contactEmail
        form.company.contactPhone = job.value.company.contactPhone
    } catch (error) {
